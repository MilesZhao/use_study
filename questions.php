...
<body>
	<div class="container">
	  ...
	  <form action="./end.php" method="get">
	  	<p>1. Do you think it is useful to extract tips for APIs?</p>
	    <div class="radio">
	    ...
	    <p>2. Do you think the extracted tips from our approach are useful to you?</p>
	    <div class="radio">
	    ...
	    <p>4. Do you think our approach can outperform the baseline?</p>
	    <div class="radio">
	    ...
	    <p>5. Do you have any recommendation/comments/thoughts?</p>
